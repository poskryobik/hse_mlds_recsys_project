...
async def message_with_text(message: Message):
    ...
    """
    await message.answer("""Команда не ясна. Пожалуйста, попробуйте ввести одну из команд:
/start - начало работы
...
async def message_with_sticker(message: Message):
    ...
    """
    await message.answer("Стикер не является командой. Пожалуйста, введите команду.")
...
async def message_with_gif(message: Message):
    ...
    """
    await message.answer("GIF не является командой. Пожалуйста, введите команду.")
...
async def message_with_gif(message: Message):
    ...
    """
    await message.answer("Изображение не является командой. Пожалуйста, введите команду")